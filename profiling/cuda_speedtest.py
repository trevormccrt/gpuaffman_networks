...
axs.plot(batch_sizes[:len(all_times_numpy)], batch_sizes[:len(all_times_numpy)]/all_times_numpy, label="Numpy")
axs.plot(batch_sizes[:len(all_times_cupy)], batch_sizes[:len(all_times_cupy)]/all_times_cupy, label="Cupy")
axs.legend()
axs.set_xscale("log")
axs.set_yscale("log")
